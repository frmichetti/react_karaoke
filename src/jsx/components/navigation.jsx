    ...
    render() {
        return (
          <nav className="navbar navbar-expand-md navbar-dark bg-dark fixed-top">
              <a className="navbar-brand" href="#"><img src="http://localhost:3000/images/logo-svg-white.svg" alt="" width={'40px'} height={'40px'} style={{fill: '#ffffff'}} className={'image'}/>Metallica Store</a>
